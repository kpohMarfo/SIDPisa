...
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(ci_route('surat_dinas')); ?>">Daftar Surat</a></li>
...
<?php $__env->startSection('content'); ?>
    ...
    <input type="hidden" id="id_surat" name="id_surat" value="<?php echo e($suratDinas->id); ?>">
    <div class="nav-tabs-custom">
        <div class="container-fluid identitas-surat">
            <h4>Surat <?php echo e($suratDinas->nama ?? ''); ?></h4>
        </div>
        ...
        <div class="tab-content">
            ...
            <?php echo $__env->make('admin.surat_dinas.pengaturan.umum', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

            <?php echo $__env->make('admin.surat_dinas.pengaturan.tinymce', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#preview').click(function(e) {
                ...
                $.ajax({
                    url: `<?php echo e(ci_route('surat_dinas/update', $suratDinas->id)); ?>`,
                    type: 'POST',
                    xhrFields: {
                        responseType: 'blob'
                    },
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OpenSID-umum\resources\views/admin/surat_dinas/pengaturan/form.blade.php ENDPATH**/ ?>