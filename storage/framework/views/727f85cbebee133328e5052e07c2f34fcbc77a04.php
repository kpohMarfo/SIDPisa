...
<?php $__env->startSection('breadcrumb'); ?>
    <li><a href="<?php echo e(ci_route('beranda')); ?>"><i class="fa fa-home"></i> Beranda</a></li>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#form-delete-dtks').on('submit', function(ev) {
                ...
                ajax_save_dtks("<?php echo e(ci_route('dtks.delete')); ?>" + "/" + dtks_id,
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OpenSID-umum\resources\views/admin/dtks/index.blade.php ENDPATH**/ ?>