...
<?php $__env->startSection('content'); ?>
    ...
    <div class="box box-info">
        <div class="box-header with-border">
            <?php if(can('u')): ?>
                <a href="<?php echo e(ci_route('wilayah.form_' . $level, $parent)); ?>" id="btn-add"
            ...
            <?php endif; ?>
            <?php if($level == 'dusun'): ?>
                <a href="<?php echo e(ci_route('wilayah.dialog.cetak')); ?>"
                ...
                <a href="<?php echo e(ci_route('wilayah.dialog.unduh')); ?>" title="Unduh Data"
            ...
            <?php else: ?>
                <a href='<?php echo e(ci_route('wilayah.cetak_' . $level, $parent)); ?>'
                    class="btn btn-social bg-purple btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"
                    title="Cetak Data" target="_blank"><i class="fa fa-print "></i> Cetak</a>
                <a href='<?php echo e(ci_route('wilayah.unduh_' . $level, $parent)); ?>' title="Unduh Data"
                    class="btn btn-social bg-navy btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OpenSID-umum\resources\views/admin/wilayah/index.blade.php ENDPATH**/ ?>