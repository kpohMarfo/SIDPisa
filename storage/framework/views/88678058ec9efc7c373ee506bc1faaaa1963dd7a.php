                ...
                <form id="mainform" action="<?php echo e(ci_route('rtm.impor')); ?>" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <br />
                            <br />
                            <a href="<?php echo e(asset('import/FormatImporRTM.xlsx')); ?>" class="btn btn-social bg-purple btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block text-center"><i class="fa fa-file-excel-o"></i> Contoh Format Impor Data Rumah Tangga</a>
                        </div>
                    </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\OpenSID-umum\resources\views/admin/penduduk/rtm/impor.blade.php ENDPATH**/ ?>