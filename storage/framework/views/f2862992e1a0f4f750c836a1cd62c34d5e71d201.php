...
<div class="tab-pane" id="template-surat">
    ...
    <div class="box-body">
        <div class="form-group">
            <textarea name="template_desa" data-filemanager='<?php echo json_encode(['external_filemanager_path' => base_url('assets/kelola_file/'), 'filemanager_title' => 'Responsive Filemanager', 'filemanager_access_key' => $session->fm_key]); ?>' data-urlkodeisian="surat_dinas" data-urlsalintemplate="surat_dinas" data-salintemplate="isi" class="form-control input-sm editor required"><?php echo e($suratDinas->template_desa ?? $suratDinas->template); ?></textarea>
        </div>
    </div>
</div>
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs customized-tab" id="tabs">
                <li data-name="utama" class="active">
                    <a href="#form-utama" data-toggle="tab"><?php echo e($suratDinas->form_isian->individu->judul ?? 'Utama'); ?></a>
                </li>
                ...
                <div class="tab-pane active" id="form-utama">
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control input-sm required judul isi-judul" name="judul" value="<?php echo e($suratDinas->form_isian->individu->judul ?: 'Utama'); ?>" minlength="3" maxlength="20">
                            </div>
                        </div>
                        <div class="row" style="margin-top: 5px">
                            <label for="isi-label" class="col-sm-2" title="Isi dengan karakter - untuk sembunyikan label">Label Bagian</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control input-sm required isi-label" name="label" value="<?php echo e($suratDinas->form_isian->individu->label ?? 'Keterangan'); ?>" minlength="1" maxlength="30">
                            </div>
                        </div>
                        <div class="row" style="margin-top: 5px">
                            <label for="isi-label" class="col-sm-2">Info Bagian</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control input-sm isi-info" name="info" value="<?php echo e($suratDinas->form_isian->individu->info ?? ''); ?>" maxlength="100">
                            </div>
                        </div>
                        <div class="row" style="margin-top: 5px">
                            ...
                            <div class="col-sm-8">
                                <input
                                    ...
                                    name="prefix"
                                    value="<?php echo e(strtolower($suratDinas->form_isian->individu->prefix ?? 'individu')); ?>"
                                    minlength="3"
                                    maxlength="50"
                                    readonly
                                >
                        ...
                        <?php echo $__env->make('admin.surat_dinas.pengaturan.kode_isian', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
                    ...
                    <div class="tab-pane" id="tab-<?php echo e($item); ?>">
                        <div class="box-body">
                            ...
                            <div class="row">
                                <label for="isi-judul" class="col-sm-2">Judul Bagian</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control input-sm required judul_tinymce isi-judul" name="kategori_judul[<?php echo e($item); ?>]" value="<?php echo e($suratDinas->form_isian->$item->judul ?? ucwords(str_replace('_', ' ', $item))); ?>" minlength="3" maxlength="20">
                                </div>
                            </div>
                            <div class="row" style="margin-top: 5px">
                                <label for="isi-label" class="col-sm-2" title="Isi dengan karakter - untuk sembunyikan label">Label Bagian</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control input-sm required judul isi-label" name="kategori_label[<?php echo e($item); ?>]" value="<?php echo e($suratDinas->form_isian->$item->label ?? ucwords(str_replace('_', ' ', $item))); ?>" minlength="1" maxlength="30">
                                </div>
                            </div>
                            <div class="row" style="margin-top: 5px">
                                <label for="isi-label" class="col-sm-2">Info Bagian</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control input-sm isi-info" name="kategori_info[<?php echo e($item); ?>]" value="<?php echo e($suratDinas->form_isian->$item->info ?? ''); ?>" maxlength="100">
                                </div>
                            </div>
                            <div class="row" style="margin-top: 5px">
                                <label for="isi-prefix" class="col-sm-2">Prefix Bagian</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control input-sm required prefix_tinymce isi-prefix" name="kategori_prefix[<?php echo e($item); ?>]" value="<?php echo e(strtolower($suratDinas->form_isian->$item->prefix ?? $item)); ?>" minlength="3" maxlength="50">
                                </div>
                            </div>
                            <hr>

                            <?php echo $__env->make('admin.surat_dinas.pengaturan.kategori_isian', ['key_kategori' => $item], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <?php endif; ?>
...
<?php echo $__env->make('admin.surat_dinas.pengaturan.pindah_kode_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('admin.surat_dinas.pengaturan.kaitkan_kode_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\OpenSID-umum\resources\views/admin/surat_dinas/pengaturan/tinymce.blade.php ENDPATH**/ ?>